...
mergeddata_urv <- subset(mergeddata_urv, !(mergeddata_urv$s %in% exclude_all_EUR_outliers$V1))
...
write.table(dv, file = "/media/veracrypt10/Analyses/annotations/scz_urv_ptv_geneset_estimates_allEURout_exclusions.tsv", sep="\t",dec = ".", row.names = F )
...
write.table(dv, file = "/media/veracrypt10/Analyses/annotations/scz_urv_syn_geneset_estimates_allEURout_exclusions.tsv", sep="\t",dec = ".", row.names = F )
