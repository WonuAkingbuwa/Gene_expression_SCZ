...
SCZ_EAS_geneset <- read.table("SCZeasauto_complete_genesets_transpose.gmt.gsa.out", header = T)

#rename common and rare variant genesets so they match 
SCZ_EAS_geneset$FULL_NAME <- as.character(SCZ_EAS_geneset$FULL_NAME)
str(SCZ_EAS_geneset)

SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "exPFC1"] <- "exPFC1"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "exPFC2"] <- "exPFC2"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "exCA1"] <- "exCA1"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "exCA3"] <- "exCA3"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GABA1"] <- "GABA1"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GABA2"] <- "GABA2"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "exDG"] <- "exDG"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "ASC1"] <- "ASC1"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "ASC2"] <- "ASC2"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "ODC1"] <- "Oligodendrocytes_human"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "OPC"] <- "Oligodendrocytes precursor cells"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "MG"] <- "Microglia_human"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "NSC"] <- "Neuronal stem cells"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "END"] <- "Endothelial cells"

SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PI_genes"] <- "PI Genes"

SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxexPFC1"] <- "PI x exPFC1"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxexPFC2"] <- "PI x exPFC2"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxexCA1"] <- "PI x exCA1"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxexCA3"] <- "PI x exCA3"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxGABA1"] <- "PI x GABA1"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxGABA2"] <- "PI x GABA2"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxexDG"] <- "PI x exDG"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxASC1"] <- "PI x ASC1"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxASC2"] <- "PI x ASC2"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxODC1"] <- "PI x Oligodendrocytes_human"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxOPC"] <- "PI x Oligodendrocytes precursor cells"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxMG"] <- "PI x Microglia_human"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxNSC"] <- "PI x Neuronal stem cells"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxEND"] <- "PI x Endothelial cells"

SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "astrocytes_ependymal"] <- "Astrocytes/ependymal"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Dopaminergic_Adult"] <- "Dopaminergic adult"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Dopaminergic_Neuroblast"] <- "Dopaminergic neuroblast"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Embryonic_Dopaminergic_Neuron"] <- "Embryonic dopaminergic neuron"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Embryonic_GABAergic_Neuron"] <- "Embryonic GABAergic neuron"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Embryonic_midbrain_nucleus_n..."] <- "Embryonic midbrain nucleus neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "endothelial-mural"] <- "Endothelial-mural"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Hypothalamic_Dopaminergic_Ne..."] <- "Hypothalamic dopaminergic neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Hypothalamic_GABAergic_Neuro..."] <- "Hypothalamic GABAergic neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Hypothalamic_Glutamatergic_N..."] <- "Hypothalamic glutamatergic neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "interneurons"] <- "Interneurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Medium_Spiny_Neuron"] <- "Medium spiny neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "microglia"] <- "Microglia_mouse"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Neural_Progenitors"] <- "Neural progenitors"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Neuroblasts"] <- "Neuroblasts"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Oligodendrocyte_Precursor"] <- "Oligodendrocyte precursor"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Oligodendrocytes"] <- "Oligodendrocytes_mouse"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Oxytocin_and_Vasopressin_Exp..."] <- "Oxytocin/vasopressin neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "pyramidal_CA1"] <- "Pyramidal (CA1)"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "pyramidal_SS"] <- "Pyramidal (S1)"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Radial_glia_like_cells"] <- "Radial glia-like cells"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Serotonergic_Neuron"] <- "Serotonergic Neuron"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Striatal_Interneuron"] <- "Striatal interneuron"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "Vascular_Leptomeningeal_Cells"] <- "Vascular leptomeningeal"


SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxastrocytes_ependymal"] <- "PI x Astrocytes/ependymal"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxDopaminergic_Adult"] <- "PI x Dopaminergic adult"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxDopaminergic_Neuroblast"] <- "PI x Dopaminergic neuroblast"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxEmbryonic_Dopaminergic_Ne..."] <- "PI x Embryonic dopaminergic neuron"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxEmbryonic_GABAergic_Neuron"] <- "PI x Embryonic GABAergic neuron" 
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxEmbryonic_midbrain_nucleus"] <- "PI x Embryonic midbrain nucleus neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxendothelial_mural"] <- "PI x Endothelial-mural"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxHypothalamic_Dopaminergic"] <- "PI x Hypothalamic dopaminergic neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxHypothalamic_GABAergic"] <- "PI x Hypothalamic GABAergic neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxHypothalamic_Glutamatergic"] <- "PI x Hypothalamic glutamatergic neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxinterneurons"] <- "PI x Interneurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxMedium_Spiny_Neuron"] <- "PI x Medium spiny neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxmicroglia"] <- "PI x Microglia_mouse"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxNeural_Progenitors"] <- "PI x Neural progenitors"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxNeuroblasts"] <- "PI x Neuroblasts"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxOligodendrocyte_Precursor"] <- "PI x Oligodendrocyte precursor"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxOligodendrocytes"] <- "PI x Oligodendrocytes_mouse"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxOxytocin_and_Vasopressin"] <- "PI x Oxytocin/vasopressin neurons"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxpyramidal_CA1"] <- "PI x Pyramidal (CA1)"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxpyramidal_SS"] <- "PI x Pyramidal (S1)"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxRadial_glia_like_cells"] <- "PI x Radial glia like cells"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxSerotonergic_Neuron"] <- "PI x Serotonergic Neuron"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxStriatal_Interneuron"] <- "PI x Striatal interneuron"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "PIxVascular_Leptomeningeal_C..."] <- "PI x Vascular leptomeningeal"

SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0007416"] <- "Synapse assembly"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0050808"] <- "Synapse organization"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "SYNGO:synprocess"] <- "Synaptic process"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0099536"] <- "Synaptic signaling"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0099537"] <- "Trans-synaptic signaling"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0050804"] <- "Modulation of chemical synaptic transmission"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0007268"] <- "Chemical synaptic transmission"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "SYNGO:metabolism"] <- "Metabolism"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "SYNGO:presynprocess"] <- "Presynaptic process"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0099504"] <- "Synaptic vesicle cycle"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "SYNGO:postsynprocess"] <- "Postsynaptic process"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0099072"] <- "Regulation of postsynaptic membrane neurotransmitter"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0099173"] <- "Postsynapse organization"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0060078"] <- "Regulation of postsynaptic membrane potential"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0016079"] <- "Synaptic vesicle exocytosis"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "SYNGO:translation_postsynapse"] <- "Translation postsynapse"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "SYNGO:translation_synapse"] <- "Translation synapse"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "SYNGO:translation_presynapse"] <- "Translation presynapse"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0099572"] <- "Postsynaptic specialization"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0098794"] <- "Postsynapse"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0045202"] <- "Synapse"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0014069"] <- "Postsynaptic density"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0098793"] <- "Presynapse"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0098839"] <- "Postsynaptic density membrane"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0099061"] <- "Integral component of postsynaptic density membrane"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0042734"] <- "Presynaptic membrane"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0099056"] <- "Integral component of presynaptic membrane"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0099055"] <- "Integral component of postsynaptic membrane"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0045211"] <- "Postsynaptic membrane"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0048786"] <- "Presynaptic active zone"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0048787"] <- "Presynaptic active zone membrane"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0008021"] <- "Synaptic vesicle"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "GO:0030672"] <- "Synaptic vesicle membrane"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "SYNGO:postsyn_ribosome"] <- "Postsynaptic ribosome"
SCZ_EAS_geneset$FULL_NAME[SCZ_EAS_geneset$VARIABLE == "SYNGO:presyn_ribosome"] <- "Presynaptic ribosome"
...
names(SCZ_EAS_geneset)[4] <- "beta_common"
names(SCZ_EAS_geneset)[6] <- "se_common"
names(SCZ_EAS_geneset)[7] <- "p_common"

#merge common and rare variants on full names
merged_genesets <- merge(scz_urv_geneset,SCZ_EAS_geneset, by="FULL_NAME")
...
table(merged_genesets$bigger_label) #no. of overlapping sig enrichment = 3
`%notin%` <- Negate(`%in%`)
...
#tiff('figure_4.tiff',width=7500,height=5500,res=600)
jpeg('figure_4.jpeg',width=10000,height=9000,res=950)
ggplot(merged_genesets, aes(x = beta, y = beta_common, size = weights)) + #make point size proportional to weights
 geom_point(aes(color = category), alpha = 0.5) +#colour points by geneset type (category)
  xlab("Beta (ultra-rare variants; EUR ancestry)") +
  ...
  ylab("Beta (common variants; EAS ancestry)") +
  theme(axis.title = element_text(size=10, face = "plain")) +
  ...
  geom_text_repel(data = merged_genesets, aes(label=bigger_label,color = category, size = 500), show.legend = F, max.overlaps = 15) + 
